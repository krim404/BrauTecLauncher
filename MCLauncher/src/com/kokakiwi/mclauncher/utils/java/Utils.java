...
public class Utils
{
    ...
    public static File getPrimWorkingDirectory(LauncherFrame launcherFrame)
    {
        return getWorkingDirectory(
                launcherFrame.getConfig().getString("updater.folderName"), null, true);
    }
    ...
    public static File getWorkingDirectory(String applicationName, String local, boolean saveLastDir)
    {
        ...
        if (local != null)
        {
            ...
            workingDirectory = new File( dir + '/' + local + "/");
        }
