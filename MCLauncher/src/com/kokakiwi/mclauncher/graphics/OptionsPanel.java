...
public class OptionsPanel extends JDialog
{
    ...
    public class AR implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent arg0)
        {
            launcherFrame.getConfig().set("repair", "true");
            rep.setText(launcherFrame.locale
                    .getString("options.willRepair"));
    ...
    public OptionsPanel(LauncherFrame parent)
    {
        ...
        labelPanel.add(new JLabel(launcherFrame.locale
                .getString("options.repairLabel") + ": ", 4));
        final JButton repair = new JButton(
                launcherFrame.locale.getString("options.repair"));
        repair.addActionListener(new AR(repair));
        fieldPanel.add(repair);
