...
public class LauncherFrame extends Frame
{
    ...
    public static Version     APP_VERSION      = new Version(0, 9, 5, 4);
    ...
    public void setConfig(Object conf)
    {
    	...
    	try
    	{
    		writeUsedMod(this.modsel,p.getID());
    	} catch(Exception e)
    	{
    		System.out.println("Cannot write modselect file");
    	}
    ...
    public String readUsedMod(File file) throws Exception
    {
    ...
    public void writeUsedMod(File file, String version) throws Exception
    {
        if (!file.exists())
        {
            file.createNewFile();
